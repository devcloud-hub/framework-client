...
function MsTeamsActivityPage({ match }) {
  const { activityId, classId, assignmentId } = match.params;
            ...
            <div className="activity-bg left-vdo">
              <div className="main-item-wrapper desktop-view">
                <div className="item-container">
                  {msAuthData && !error && <Activity activityId={activityId} />}
                  {(!msAuthData || error) && (
...
export default connect(mapStateToProps, mapDispatchToProps)(MsTeamsActivityPage);
