      ...
      content: (
        <div>
          ...
          <div className="steps--message_box">
            <p>
              For more detail visit the komodo official site
            </p>
          ...
          {permission?.["Record a Video"]?.includes(
            ...
            <div className="komodo-ext-btn">
              ...
              >
                ...
                collaborate faster and share your ideas with people
                without the need to type lots of text, and scheduling
                online meetings. <br />For more detail visit the komodo
                official site.<br/>
                <div class="message--box_links"><a href="https://komododecks.com/" target="_blank">Komodo Help</a></div>
              </OverlayTriggerPop>
